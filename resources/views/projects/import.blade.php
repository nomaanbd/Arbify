        ...
        <div class="form-group row">
            ...
            <div class="col-md-6 pt-2">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" id="override_message_values" name="override_message_values" value="1" class="custom-control-input" @if(old('override_message_values')) checked @endif>
...
@push('scripts')
<script>
    var fileUploadLink = "{{ env('APP_DIR', '') == '' ? '' : '/'.env('APP_DIR', '') }}";

    $('#files').filepond({
        server: {
            url: fileUploadLink + '/filepond',
            headers: {
